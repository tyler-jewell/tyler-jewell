...
|------|-------------------------|------------|
| `tyler-jewell/` (umbrella, scripts) | Bash | bash-language-server |
| `tyler-jewell/agent-kit/` | Bash | bash-language-server |
| `tyler-jewell/docs/*`, `hosts/*` | Markdown (docs) | none required for pure docs |
| `herdr-web/` | JavaScript, Python, Bash, HTML/CSS | typescript-language-server, Pyright, bash-language-server |
